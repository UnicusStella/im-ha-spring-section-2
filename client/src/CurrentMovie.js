    ...
    <>
      <div className='left-current-side'>
        <div className='current-movie'>
          ...
          <img className='thumbnail' src='https://yts.lt/assets/images/movies/avengers_infinity_war_2018/medium-cover.jpg' alt='thumbnail' />
          <p className='rating'>rating : 8.5</p>
          <p className='running-time'>runtime : 149min</p>
          <p>description</p>
          <p className='description'>As the Avengers and their allies have continued to protect the world
